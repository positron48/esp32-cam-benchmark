        ...
        if (doc.containsKey("type")) {
            ...
            if (type == "offer") {
                ...
                answer["sdp"] = "v=0\r\n"
                               ...
                               "a=ice-ufrag:" + String(random(0xFFFFFFFF), HEX) + "\r\n"
                               "a=ice-pwd:" + String(random(0xFFFFFFFF), HEX) + "\r\n"
                               "a=fingerprint:sha-256 " + String(random(0xFFFFFFFF), HEX) + "\r\n"
                               "a=setup:active\r\n"
                               "a=mid:video\r\n"
                               "a=sendonly\r\n"
                               "a=rtcp-mux\r\n"
...
void sendWebRTCFrame(camera_fb_t* fb) {
    if (webrtcState != CONNECTED || !fb) return;
